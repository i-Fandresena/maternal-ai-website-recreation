      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {galleryItems.map((item) => (
            <div
              key={item.id}
              className="group relative bg-gradient-to-br from-gray-100 to-gray-50 rounded-lg overflow-hidden aspect-square cursor-pointer hover:shadow-xl transition duration-300"
            >
              {/* Image Background */}
